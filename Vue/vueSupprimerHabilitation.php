<?php $this->titre = "Supprimer une habilitation"; ?>
<form class="form-inline well" action="index.php?categorie=responsable&action=suppression" method="post"style="text-align:center;">
